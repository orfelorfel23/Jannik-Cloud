...
NEEDS_POSTGRES=true
DB_NAME=linkding_db
DB_USER=linkding_user
DB_PASSWORD=${DB_PASSWORD}
LINKDING_SUPERUSER_NAME=Jannik
LINKDING_SUPERUSER_PASSWORD=$(generate_password)
EOF

chmod 600 "${SCRIPT_DIR}/.env"

cat > "${SCRIPT_DIR}/linkding.caddy" <<'EOF'
link.orfel.de {
...
echo "Linkding environment generated."
