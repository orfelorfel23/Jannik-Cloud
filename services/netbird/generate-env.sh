...
# Internal Management Key (Generated by service.init if empty)
# NETBIRD_MANAGEMENT_KEY=

# Internal JWT Secret (Generated by service.init if empty)
# NETBIRD_JWT_SECRET=

# CoTurn/STUN (optional, but good for NAT traversal)
