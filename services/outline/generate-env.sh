#!/bin/bash
#
# Outline - Generate environment variables
#
...
echo "Generating Outline .env file..."
...
UTILS_SECRET_KEY=$(generate_password 32)
DB_USER=outline_user
DB_PASSWORD=$(generate_password 32)
OIDC_CLIENT_ID=$(generate_password 32)
OIDC_CLIENT_SECRET=$(generate_password 32)
EOF
